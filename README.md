...
- Multer + Cloudinary (media uploads & delivery)
- Nodemailer (OTP/email delivery)
- Helmet + express-rate-limit (security hardening)

#### AI / RAG (Lecture Chat Assistant)

- LangChain
- Qdrant (vector database)
- Hugging Face Inference (embeddings & chat completion)
...
```bash
$ git clone https://github.com/Armunshi/WhatheCode-LearnStream
```
...
- [Abdul Razzaq Munshi](https://github.com/Armunshi): munshiabdulrazzaq@gmail.com
